...
<div class="banner">
    <div class="bd">
        <ul>
            <li style="background:url(img/banner-1.jpg)/*tpa=http://demo.mxyhn.xyz:8020/cssthemes6/1.27ZF11/img/banner.jpg*/ #194982 center 0 no-repeat;"><a target="_blank" href="#"></a></li>
        </ul>
    </div>
</div>
<!--banner end-->
    ...
    <div class="content clearfix">
        ...
        <div class="bottom clearfix">
            ...
            <div class="middle clearfix fl">
                <ul>
                    <li><img src="${pageContext.request.contextPath}/img/ewm.jpg" tppabs="http://demo.mxyhn.xyz:8020/cssthemes6/1.27ZF11/upload/ewm.jpg"/></li>
                    <li><img src="${pageContext.request.contextPath}/img/ewm.jpg" tppabs="http://demo.mxyhn.xyz:8020/cssthemes6/1.27ZF11/upload/ewm.jpg"/></li>
                </ul>
            </div>
            <div class="right clearfix fr">
